...
## Loading page data in SvelteKit
...
## Showing a user with a specific ID 
...
The keen eyed among you may have noticed that we are not handling the case where the user with the given ID does not exist in the database.
